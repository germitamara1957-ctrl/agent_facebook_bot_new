...
import {
  Bot, Package, ShoppingCart, MessageSquare, MessageCircle,
  Facebook, Menu, Home, Calendar, HelpCircle, LogOut, Settings,
  Megaphone, Users, ShieldCheck, ClipboardList, Truck, Sun, Moon
} from "lucide-react";
  ...
  return (
    <NotificationProvider>
      <div className="flex h-screen w-full bg-background text-foreground overflow-hidden" dir="rtl">
        ...
        <aside className="flex flex-col border-l border-border bg-card shadow-sm z-10" style={{ width: "280px", minWidth: "280px" }}>
