...
const STATUS_BADGE: Record<string, { label: string; className: string }> = {
  draft:   { label: "مسودة / Draft",        className: "bg-muted text-foreground/80"  },
  sending: { label: "جاري الإرسال / Sending", className: "bg-blue-100 text-blue-700"  },
          ...
          <DialogContent dir="rtl" className="max-w-lg">
            ...
            <div className="space-y-4 mt-2 max-h-[70vh] overflow-y-auto pe-1">
              ...
              <div className="space-y-1.5">
                ...
                />
                {imagePreview && (
                  <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border bg-muted/40">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 py-2 rounded-xl border text-sm font-medium transition-all ${sendMode === "immediate" ? "bg-primary text-primary-foreground border-primary" : "bg-muted/40 border-border"}`}
                  >
                    🚀 فوري / Immediate
                  </button>
                  <button
                    ...
                    className={`flex-1 py-2 rounded-xl border text-sm font-medium transition-all ${sendMode === "scheduled" ? "bg-primary text-primary-foreground border-primary" : "bg-muted/40 border-border"}`}
                  >
                    ⏰ مجدول / Scheduled
                  </button>
                </div>
