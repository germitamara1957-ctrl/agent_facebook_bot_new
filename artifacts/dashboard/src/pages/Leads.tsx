...
const getLabelStyle = (label: string) => LABEL_OPTIONS.find((l) => l.value === label) ?? { label, color: "bg-muted text-muted-foreground" };
...
export default function Leads() {
  ...
  const summaryStats = [
    { key: "all", label: "إجمالي / Total", value: leads.length, color: "text-foreground/80" },
